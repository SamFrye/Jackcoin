...
namespace parameters {
  ...
  const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 0x81; // addresses start with "j"
  ...
  const char     CRYPTONOTE_BLOCKS_FILENAME[]                  = "jack-blocks.dat";
  const char     CRYPTONOTE_BLOCKINDEXES_FILENAME[]            = "jack-blockindexes.dat";
  const char     CRYPTONOTE_BLOCKSCACHE_FILENAME[]             = "jack-blockscache.dat";
  const char     CRYPTONOTE_POOLDATA_FILENAME[]                = "jack-poolstate.bin";
  const char     P2P_NET_DATA_FILENAME[]                       = "jack-p2pstate.bin";
  const char     CRYPTONOTE_BLOCKCHAIN_INDICES_FILENAME[]      = "jack-blockchainindices.dat";
  const char     MINER_CONFIG_FILE_NAME[]                      = "jack-miner_conf.json";
  } // parameters
...
const char     CRYPTONOTE_NAME[]                             = "jackcoin";
const char     GENESIS_COINBASE_TX_HEX[]                     = "010a01ff0001904e029b2e4c0281c0b02e7c53291a94d1d0cbff8883f8024f5142ee494ffbbd08807121017d42325ec9f68d65df46e03e52991f1403efa80a4fd3e905a5013e388f81cab7";
